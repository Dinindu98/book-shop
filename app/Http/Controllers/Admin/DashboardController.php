...
class DashboardController extends Controller
{
    ...
    {
        $trendingBook = Payment::select('book_id',DB::raw('COUNT(id) as cnt', 'book_id'))
        ...
        $books = Book::all();
      // $posts = Post::whereDate('created_at', Carbon::now()->subHours(24))->get();
       return view('admin.home')->with(['payments'=>$payments,'trendingBook'=>$trendingBook]);
       //return $trendingBook;
